...
function Categories() {
    ...
    const handleRemove = (obj) => {
        ...
        if(confirmation) {
           ...
           axios.delete(`http://localhost:3504/api/categories/${obj._id}`)
            .then((response) => {
    ...
    const handleEdit = (obj) => {
        ...
        if(input.trim()) {
            ...
            axios.put(`http://localhost:3504/api/categories/${obj._id}`, formData)
                .then((response) => {
                    const result = response.data 
    ...
    const handleSubmit = (e) => { 
        ...
        useEffect(() => {
            ...
            axios.get('http://localhost:3504/api/categories')
                .then((response) => {
                    const result = response.data 
